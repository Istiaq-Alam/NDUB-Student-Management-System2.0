...
<html lang="en">
    <head>
        ...
        background: url(./back9.jpg) no-repeat;
                    ...
                    <div class="main-page">
                        <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-6">
                                    <h2 class="title" style="color:#021b3c;">Manage Course Combination</h2>
                            ...
                            <div class="row breadcrumb-div">
                                <div class="col-md-6">
                                    <ul class="breadcrumb">
                                        ...
                                        <li> Courses</li>
            							<li class="active">Manage Course Combination</li>
            						</ul>
                                </div>
                            </div>
                            <!-- /.row -->
...
<tr>
 <td><?php echo htmlentities($cnt);?></td>
                                                            <td>Semester- <?php echo htmlentities($result->ClassName);?> &nbsp; Batch- <?php echo htmlentities($result->Section);?></td>
...
<?php if($stts=='0')
{ ?>
<a href="manage-subjectcombination.php?acid=<?php echo htmlentities($result->scid);?>" onclick="confirm('do you really want to ativate this Course');"><i class="fa fa-check" title="Acticvate Record"></i> </a><?php } else {?>

<a href="manage-subjectcombination.php?did=<?php echo htmlentities($result->scid);?>" onclick="confirm('do you really want to deativate this Course');"><i class="fa fa-times" title="Deactivate Record"></i> </a>
<?php }?>
</td>
</tr>
<?php $cnt=$cnt+1;}} ?>
