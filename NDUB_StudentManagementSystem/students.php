...
<html lang="en">
    <head>
        ...
        background: url(./back7.jpg) no-repeat;
                                        ...
                                        <div class="container">
                                            <div class="panel-heading">
                                                <div align="center" class="panel-title">
                                                    <h2 style="color: #021b3c;" class="hd">View Students Info</h2>
                                                </div>
                                            </div>
<?php if($msg){?>
...
echo htmlentities('Active');
   ...
   echo htmlentities('Blocked'); 
                                                                ...
                                                                ?></td>
<td>
<a href="students-edit.php?stid=<?php echo htmlentities($result->StudentId);?>"><i class="fa fa-edit" title="Edit Record"></i> </a> 
