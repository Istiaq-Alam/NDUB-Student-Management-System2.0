<div class="left-sidebar bg-black-300 box-shadow " style="background-color:#021b3c;">
                        <div class="sidebar-content">
                            <div class="user-info closed">
                                <img src="./logobg.png" width="100" alt="istiaq" class="img-circle profile-img">
                                <h6 class="title">NDUB Admin</h6>
                                <small class="info">Developed By Istiaq Alam</small>
                            </div>
                            <!-- /.user-info -->
                            ...
                            <div class="sidebar-nav">
                                <ul class="side-nav color-gray">
                                    ...
                                    <li class="has-children">
                                        ...
                                        <ul class="child-nav">
                                            <li><a href="create-class.php"><i class="fa fa-bars"></i> <span>Create Semester</span></a></li>
                                            <li><a href="manage-classes.php"><i class="fa fa fa-server"></i> <span>Manage Semester</span></a></li>
  ...
  <li class="has-children">
                                        ...
                                        <ul class="child-nav">
                                            <li><a href="create-subject.php"><i class="fa fa-bars"></i> <span>Create a new Course</span></a></li>
                                           ...
                                           <a href="manage-subjectcombination.php"><i class="fa fa-newspaper-o"></i> <span>Manage Course Combination </span></a></li>
                                        </ul>
                                    </li>
   <li class="has-children">
