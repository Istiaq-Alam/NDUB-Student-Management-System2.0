...
<head>
    ...
    <title>NDUB Student Management System | Admin Login</title>
    ...
    body {
        ...
        background: url(assets/img/back3.jpg) no-repeat;
...
<body class="">
    <div class="main-wrapper">
        ...
        <div style="background-color:#021b3c;height:72px; margin: 0px 0px 0px 0px">..
            <a href="index.php"><img src="https://ndub.edu.bd/wp-content/uploads/2023/06/NDUB-Logo-1.png" alt="logo" width="270"
                height="60"></a>
            </img>
        </div>
        <div class="main-wrapper">
            <div class="container">
                ...
                <h1><img align="left" src="./logobg.png" width="100" height="100" alt="logo">Notre Dame University Bangladesh 
                <br><br>Student Management System</h1>
                            ...
                            <div class="col-md-10 col-md-offset-1 pt-50">
                                ...
                                <div class="row mt-30 ">
                                    <div class="col-md-11">
                                        <div class="panel">
                                            ...
                                            <div class="panel-body p-20">
                                                ...
                                                <div class="section-title">
                                                    <p class="sub-title">S.M.S. Admin Login</p>
                                                </div>

                                                <form class="form-horizontal" method="post">
                                                    <div class="form-group">
                                                        <label for="inputEmail3"
                                                            class="col-sm-2 control-label">AdminID</label>
                                                        <div class="col-sm-10">
                                                            <input type="text" name="username" class="form-control"
                                                                id="inputEmail3" placeholder="Admin ID">
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                        ...
                                        <!-- /.panel -->
                                        <p class="text-muted text-center"><small>Istiaq Alam</a></small> </p>
                                    </div>
                                    <!-- /.col-md-11 -->
                                </div>
                                <!-- /.row -->
