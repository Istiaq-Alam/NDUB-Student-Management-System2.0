...
$dob=$_POST['dob']; 
$status=1;
$sql="INSERT INTO  tblstudents(StudentName,RollId,StudentEmail,Pass,Gender,ClassId,DOB,Status) VALUES(:studentname,:roolid,:studentemail,:studentpass,:gender,:classid,:dob,:status)";
$query = $dbh->prepare($sql);
$query->bindParam(':studentname',$studentname,PDO::PARAM_STR);
$query->bindParam(':roolid',$roolid,PDO::PARAM_STR);
$query->bindParam(':studentemail',$studentemail,PDO::PARAM_STR);
$query->bindParam(':studentpass',$studentpass,PDO::PARAM_STR);
...
<body class="top-navbar-fixed">
    ...
    <div style="background-color:#afa014;height:4px; margin: 0px 0px 0px 0px"></div>
        ...
        <div style="background-color:#021b3c;height:72px; margin: 0px 0px 0px 0px">..
            <a href="index3.php"><img src="https://ndub.edu.bd/wp-content/uploads/2023/06/NDUB-Logo-1.png" alt="logo" width="270"
                height="60"></a>
            </img>
        </div>
                                ...
                                <div class="container">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="alert alert-success left-icon-alert" role="alert">
                                            ...
                                            <a href="index3.php">Login here</a></div><?php } 
else if($error){?>
