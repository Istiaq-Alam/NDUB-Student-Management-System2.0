...
$sql ="SELECT `StudentEmail`,`Pass` FROM tblstudents WHERE StudentEmail=:uname and Pass=:password";
                                        ...
                                        <div class="panel-body p-20">
                                            ...
                                            <form class="form-horizontal" action="stddashboard.php" method="post">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input type="email" name="umail" class="form-control" id="inputEmail3"
                                                    ...
                                                    <div class="col-sm-offset-2 col-sm-10">
                                                        ...
                                                        <button type="submit" name="create"
                                                            class="btn btn-labeled pull-left"> <a
                                                                href="studentsup.php">Create New Account</a>
                                                        </button>
                                                    </div>
                                                </div>
                                            </form>
