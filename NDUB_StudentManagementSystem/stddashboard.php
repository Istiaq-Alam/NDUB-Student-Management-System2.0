...
<head>
    ...
    <title>NDUB Student Portal | Student Dashboard</title>
    ...
    <div class="main-wrapper">
        ...
        <div class="content-wrapper">
            <div class="content-container">
                ...
                <?php include('includes/leftbarstd.php');?>
...
?>
                                            ...
                                            <span
                                                class="number counter"><?php echo htmlentities($totalstudents);?></span>
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                        <a class="dashboard-stat bg-danger" href="stddashboard.php">
                                            <?php
...
?>
                                            <span
                                                class="number counter"><?php echo htmlentities($totalsubjects);?></span>
                                            <span class="name">List of Courses</span>
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                        <a class="dashboard-stat bg-warning" href="stddashboard.php">
                                            <?php
...
?>
                                            <span
                                                class="number counter"><?php echo htmlentities($totalclasses);?></span>
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                        <a class="dashboard-stat bg-success" href="find-result.php">
                                            <?php
...
?>
                                            ...
                                            <span
                                                class="number counter"><?php echo htmlentities($totalresults);?></span>
        ...
        $(function() {
            ...
            toastr["success"]("Welcome to NDUB student Management System!");
            toastr["success"]("Login as Student Successfully !");
        });
        </script>
